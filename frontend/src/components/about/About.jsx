		...
		<section className="container container__about" id="about" >
			...
			<div className="row">
				...
				<div className="col-12 col-md-6 col-lg-6 mx-auto">
					<img src='./images/africamap.jpg' className="dp_image" alt='FarmCon' />
				</div>
			</div>
			<div className="row">
				<div className="heading">
			...
			<div className="row">
				<div className="cards">
					...
					<div className="card">
						<img src="./images/taofeeq-dp.png" className="card-img-top" alt="..." />
						<div className="card-body">
					...
					<div className="card">
						<img src="./images/khadijah.jpg" className="card-img-top" alt="..." />
						<div className="card-body">
					...
					<div className="card">
						<img src="./images/aliyu.png" className="card-img-top" alt="..." />
						<div className="card-body">
